...
public class Status extends WeiboResponse implements java.io.Serializable {
	...
	public static StatusWapper constructWapperStatus(Response res) throws WeiboException {
		...
		try {
			...
			return new StatusWapper(status, previousCursor, nextCursor, totalNumber,
					hasvisible);
	...
	public String toString() {
		return "Status [user=" + user + ", idstr=" + idstr + ", createdAt=" + createdAt
				+ ", id=" + id + ", text=" + text + ", favorited=" + favorited
				+ ", truncated=" + truncated + ", inReplyToStatusId=" + inReplyToStatusId
				+ ", inReplyToUserId=" + inReplyToUserId + ", inReplyToScreenName="
				+ inReplyToScreenName + ", retweetedStatus=" + retweetedStatus + ", geo="
				+ geo + ", latitude=" + latitude + ", longitude=" + longitude
				+ ", repostsCount=" + repostsCount + ", commentsCount=" + commentsCount
				+ ", mid=" + mid + ", mlevel=" + mlevel + ", visible=" + visible + "]";
	}
